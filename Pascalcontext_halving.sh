...
#do
#  echo "head" $head
CUDA_VISIBLE_DEVICES=2 python pnp_get_attention_textloc_weaklysupervised_search_PSC.py \
--save_path Cbatch_Eval_test_ddp_1111_$320_flickrfinetune_zeroshot_halvingdrop_PSC \
