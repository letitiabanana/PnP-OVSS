...
if __name__ == "__main__":
    ...
    # filename_list = []
    # for (dirpath, dirnames, filenames) in walk("/home/letitiabanana/CODE-PNP-OVSS/LAVIS/Test_PSC/gradcam/max_att_block_num8_del_patch_numsort_thresh005/drop_iter0/img_att_forclasses/"):
