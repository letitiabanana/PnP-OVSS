import numpy as np
data_type = "coco object"


if data_type == "coco object":
...
for file_dir in ['all_drop_hist_with_filtered_caption']: #'hist_withfiltered_caption',
    import os
    if data_type == "voc":
        path = f"/home/letitiabanana/LAVIS/BLIP_0602_448_VOC_GPT4O_filter70_filtereddrop10patches_repeat1drop_blurcrf_89D4/{file_dir}/"
    elif data_type == "coco object":
        # path = f"/home/letitiabanana/LAVIS/BLIP_0602_224_cocothing_GPT4O_filter70_filtereddrop10patches_repeat1drop_3background_blurcrf_89D4/{file_dir}/"
        path = f"/home/letitiabanana/LAVIS/BLIP_0602_448_cocothing_GPT4O_filter70_filtereddrop10patches_repeat1drop_blurcrf_3background_89D4/{file_dir}/"

    elif data_type == "psc":
        path = f"/home/letitiabanana/LAVIS/BLIP_0602_448_PSC_GPT4O_filter70_filtereddrop10patches_repeat1drop_blurcrf_3background_89D4/{file_dir}/"
    elif data_type == "ade20k":
        path = f"/home/letitiabanana/LAVIS/BLIP_0602_448_ADE20K_segmentation_GPT4O_filter70_filtereddrop10patches_repeat1drop_blurcrf_3background_89D4/{file_dir}/"
    elif data_type == "coco stuff":
        path = f"/home/letitiabanana/LAVIS/BLIP_0602_448_cocoall_GPT4O_filter70_filtereddrop10patches_repeat1drop_blurcrf_3background_89D4/{file_dir}/"
...
def count_file():
    from os import walk
    path = "/home/letitiabanana/LAVIS/Eval_test_ddp_0307/img_att_forclasses/"
    filename_list = []
