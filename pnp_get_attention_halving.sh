...
#do
#  echo "head" $head
CUDA_VISIBLE_DEVICES=1  python pnp_get_attention_textloc_weaklysupervised_search.py \
  --save_path correct_Cbatch_Eval_test_ddp_1111_320_flickrfinetune_zeroshot_cocothing_halvingdrop \
